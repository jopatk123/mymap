...
const uploaders = {
  // 单文件上传
  single: createUploader(createStorage('panoramas', 'panorama'), fileFilter),

  // 批量上传
  batch: createUploader(createStorage('panoramas', 'panorama'), fileFilter, { files: 10 }),

  // 视频上传
  video: createUploader(createStorage('videos', 'video'), videoFileFilter, {
