...
class PointStyleController {
  static async getVideoPointStyles(req, res) {
    try {
      ...
      res.status(500).json({ success: false, message: '获取视频点位样式配置失败', error: error.message })
    }
  }
  ...
  static async updateVideoPointStyles(req, res) {
    try {
      ...
      res.status(500).json({ success: false, message: '更新视频点位样式配置失败', error: error.message })
    }
  }
  ...
  static async resetVideoPointStyles(req, res) {
    try {
      ...
      res.status(500).json({ success: false, message: '重置视频点位样式配置失败', error: error.message })
    }
  }
  ...
  static async getPanoramaPointStyles(req, res) {
    try {
      ...
      res.status(500).json({ success: false, message: '获取全景图点位样式配置失败', error: error.message })
    }
  }
  ...
  static async updatePanoramaPointStyles(req, res) {
    try {
      ...
      res.status(500).json({ success: false, message: '更新全景图点位样式配置失败', error: error.message })
    }
  }
  ...
  static async resetPanoramaPointStyles(req, res) {
    try {
      ...
      res.status(500).json({ success: false, message: '重置全景图点位样式配置失败', error: error.message })
    }
  }
}
