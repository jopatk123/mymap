...
CREATE TABLE IF NOT EXISTS kml_file_styles (
  ...
  -- 点样式配置
  point_color VARCHAR(7) DEFAULT '#ff7800' COMMENT '点颜色',
  ...
  point_label_color VARCHAR(7) DEFAULT '#000000' COMMENT '标签颜色',
  
  -- 线样式配置
  line_color VARCHAR(7) DEFAULT '#ff7800' COMMENT '线颜色',
  ...
  -- 面样式配置
  polygon_fill_color VARCHAR(7) DEFAULT '#ff7800' COMMENT '面填充颜色',
  polygon_fill_opacity DECIMAL(3,2) DEFAULT 0.3 COMMENT '面填充透明度',
  polygon_stroke_color VARCHAR(7) DEFAULT '#ff7800' COMMENT '面边框颜色',
  ...
  cluster_icon_color VARCHAR(7) DEFAULT '#409EFF' COMMENT '聚合图标颜色',
