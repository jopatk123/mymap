  ...
  >
    <div class="export-content">
      ...
      <div class="filename-setting">
        <h4>文件名</h4>
        <el-input v-model="exportFilename" placeholder="请输入文件名" :suffix-icon="Edit">
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button :disabled="!hasDrawings" @click="previewData">预览</el-button>
        <el-button type="primary" :loading="exporting" :disabled="!hasDrawings" @click="exportData">
...
const previewData = () => {
  ...
  ElMessage({
    type: 'info',
    message: `当前绘图数据：共${total}项 (${parts.join('、')})`,
    duration: 4000,
  });
};
...
.filename-setting .el-input .el-input__wrapper {
  border-radius: 6px;
}
