...
<template>
  ...
  >
    <div class="line-info-popup">
      ...
      <div v-if="line" class="popup-content">
        <div v-if="line.description" class="info-item">
        ...
        <div class="info-item">
          ...
          <div class="style-preview">
            <div class="color-dot" :style="{ backgroundColor: line.color || '#3388ff' }"></div>
        ...
        <div v-if="line.timestamp" class="info-item">
        ...
        <div class="popup-actions">
          ...
          <el-button type="danger" size="small" @click="$emit('delete-line')"> 删除 </el-button>
        </div>
      </div>
    </div>
  </el-popover>
