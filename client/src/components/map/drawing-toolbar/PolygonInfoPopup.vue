...
<template>
  ...
  >
    <div class="polygon-info-popup">
      ...
      <div v-if="polygon" class="popup-content">
        <div v-if="polygon.description" class="info-item">
        ...
        <div class="info-item">
          ...
          <div class="style-preview">
            ...
            <span class="style-text">
              边框 {{ polygon.weight || 3 }}px，填充
              {{ Math.round((polygon.fillOpacity || 0.2) * 100) }}%
            </span>
          </div>
        </div>

        <div v-if="polygon.timestamp" class="info-item">
        ...
        <div class="popup-actions">
          ...
          <el-button type="danger" size="small" @click="$emit('delete-polygon')"> 删除 </el-button>
        </div>
      </div>
    </div>
  </el-popover>
