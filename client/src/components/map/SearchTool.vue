            ...
            <el-scrollbar max-height="300px">
              ...
              >
                <div class="result-title">
                  ...
                  <span v-html="highlightKeyword(result.name, kmlSearchKeyword)"></span>
                </div>
                <div v-if="result.description" class="result-description">
                  <span v-html="highlightKeyword(result.description, kmlSearchKeyword)"></span>
                </div>
...
const searchAddresses = async () => {
  ...
  try {
    ...
    const tips = (response.tips || []).filter(tip => 
      tip.location && tip.location.split(',').length === 2
    )
