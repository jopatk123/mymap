    ...
    <div class="kml-style-container">
      ...
      <div class="kml-file-list">
        <div class="list-header">
          <h3>{{ listTitle }}</h3>
          <el-tag v-if="props.basemapMode" type="warning" size="small"> 底图模式 </el-tag>
        ...
        <el-scrollbar height="500px">
          ...
          >
            <div class="file-info">
              ...
              <el-tag v-if="kmlFile.is_basemap" type="warning" size="small" class="file-type-tag">
                底图
              </el-tag>
            </div>
      ...
      <div class="style-editor-panel">
        <el-tabs v-if="selectedKmlFile" v-model="activeTab">
          <el-tab-pane label="点样式" name="point">
            <PointStyleEditor v-model="currentStyles.point" @change="handleStyleChange" />
          </el-tab-pane>

          <el-tab-pane label="线样式" name="line">
            <LineStyleEditor v-model="currentStyles.line" @change="handleStyleChange" />
          </el-tab-pane>

          <el-tab-pane label="面样式" name="polygon">
            <PolygonStyleEditor v-model="currentStyles.polygon" @change="handleStyleChange" />
          </el-tab-pane>
        </el-tabs>
