<template>
  <div class="video-info">
    ...
    <div class="video-details">
      ...
      <div class="detail-row" v-if="video?.description">
        <span class="label">描述：</span>
        <span class="value">{{ video.description }}</span>
      </div>
      
      <div class="detail-row" v-if="video?.duration">
      ...
      <div class="detail-row" v-if="video?.createdAt">
        <span class="label">创建时间：</span>
        <span class="value">{{ Formatters.formatDate(video.createdAt) }}</span>
      </div>
      
      <div class="detail-row" v-if="video?.folderName">
